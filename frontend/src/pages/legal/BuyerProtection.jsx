...
const BuyerProtection = () => {
    return (
        <LegalLayout title="Buyer Protection Policy">
            ...
            <p>If you encounter an issue, you must file a dispute through your Order History within 48 hours of marked delivery. TrustPayEcommerceEcommerce will freeze the funds and conduct a formal investigation to resolve the issue fairly.</p>
