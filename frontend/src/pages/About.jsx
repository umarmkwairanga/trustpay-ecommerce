...
const About = () => {
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <h1 className="text-4xl font-bold mb-6">About TrustPay</h1>
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-3">Our Mission</h2>
        <p className="text-gray-700">
          TrustPay is dedicated to revolutionizing online commerce in Nigeria by providing a 
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-3">Why Choose TrustPay?</h2>
