...
const EscrowDashboard = () => {
  ...
  const handleCreateEscrow = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(`🔒 Funds successfully secured in TrustPayEcommerceEcommerce Escrow!`);
        setAmount('');
      } else {
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '40px auto', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      <h2 style={{ borderBottom: '2px solid #006633', paddingBottom: '10px', color: '#006633' }}>🛡️ TrustPayEcommerceEcommerce Escrow Hub (NGN)</h2>
      ...
      <h3>Active TrustPayEcommerceEcommerce Holds</h3>
