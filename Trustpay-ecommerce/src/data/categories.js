export const CATEGORIES = [
  { id: 'real-estate', name: 'Real Estate', fields: ['Property Type', 'Bedrooms', 'Area (sqft)'] },
  ...
  { id: 'industrial', name: 'Business & Industrial', fields: ['Equipment Type', 'Power Specs', 'Condition'] },
  { id: 'education', name: 'Education & Digital', fields: ['Format', 'Access Level', 'Version'] },
  { id: 'pets', name: 'Pet Care', fields: ['Animal Type', 'Age', 'Breed', 'Vaccinated'] },
  { id: 'art-collectibles', name: 'Art & Collectibles', fields: ['Era', 'Authenticity', 'Material'] },
  { id: 'events', name: 'Events & Experiences', fields: ['Date', 'Venue', 'Capacity'] }
];